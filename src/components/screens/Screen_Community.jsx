              ...
              <div key={i} style={{
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 4 }}>
                    ...
                    {th.p && <span className="sx-pill"><LogoTile p={th.p} size={14} /> {th.p.name}</span>}
                  </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 6, fontSize: 11, color: 'var(--text-muted)' }}>
                    <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                      <div className="sx-avatar" style={{ width: 18, height: 18, fontSize: 9 }}>{th.author.split(' ').map(x => x[0]).join('')}</div>
          ...
          <div className="sx-card" style={{ padding: 16 }}>
            ...
            {[
              ...
              <div key={u.n} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '7px 0', borderBottom: i < 4 ? '1px solid var(--border)' : 0 }}>
                ...
                <div className="sx-avatar" style={{ width: 24, height: 24, fontSize: 10 }}>{u.n.split(' ').map(x => x[0]).join('')}</div>
