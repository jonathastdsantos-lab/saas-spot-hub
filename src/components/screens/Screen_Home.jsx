      ...
      <div style={{ padding: "60px 80px 40px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 880, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            A infraestrutura
            <br />
            <span className="sx-serif" style={{ fontWeight: 400, fontStyle: "italic", color: "var(--acc)" }}>
              inteligente
            </span>{" "}
            do mercado SaaS.
          </h1>
          <p
            style={{ fontSize: 17, color: "var(--text-dim)", margin: "20px auto 36px", maxWidth: 620, lineHeight: 1.5 }}
          >
            Descubra, compare e contrate softwares e agentes IA com um consultor que entende seu negócio. Sem planilha,
            sem comparativo enviesado, sem perder uma semana pesquisando.
          </p>
      ...
      <div style={{ padding: "20px 80px 32px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 10 }}>
          {categories.slice(0, 12).map((c, i) => (
            ...
            >
              <Icon name={c.icon || "sparkle"} size={18} stroke="var(--acc)" />
              <div>
      ...
      <div style={{ padding: "24px 80px 28px" }}>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 18 }}>
          <h3 style={{ fontSize: 22, fontWeight: 500, letterSpacing: "-0.02em", margin: 0 }}>
            Em destaque{" "}
            <span style={{ color: "var(--text-muted)", fontSize: 13, fontFamily: "var(--font-mono)", fontWeight: 400 }}>
              · curado pela editora
            </span>
          </h3>
          ...
          {featured.map((p, i) => (
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 11, color: "var(--text-muted)" }}>
                <Stars value={p.stars || 5} /> {p.stars || 5} · {p.reviews || 0}
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <div className="sx-pill" style={{ background: "transparent", borderColor: "transparent", padding: 0 }}>
                  Score <strong style={{ color: "var(--acc)", marginLeft: 4 }}>{p.score || 99}</strong>
                </div>
              </div>
            </div>
          ))}
      ...
      <div style={{ padding: "8px 80px 60px", display: "grid", gridTemplateColumns: "1.6fr 1fr", gap: 18 }}>
        ...
        <div className="sx-card" style={{ padding: 0, overflow: "hidden" }}>
          ...
          >
            ...
            <div className="sx-mono" style={{ fontSize: 11, color: "var(--text-muted)" }}>
              Atualizado há 4 min
            </div>
          </div>
          {trending.map((p, i) => (
            ...
            >
              <div className="sx-mono" style={{ fontSize: 12, color: "var(--text-muted)", textAlign: "right" }}>
                {i + 1}
              </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 11, color: "var(--text-dim)" }}>
                <Stars value={p.stars || 5} size={10} /> {p.stars || 5}
              </div>
        ...
        >
          ...
          <h3
            className="sx-serif"
            style={{ fontSize: 28, fontWeight: 400, letterSpacing: "-0.01em", margin: "4px 0 14px", lineHeight: 1.15 }}
          >
            Conte o que você precisa.
            <br />
            Eu monto a stack inteira.
          </h3>
          ...
          <button
            ...
            style={{ width: "100%", justifyContent: "center", background: "var(--ai)", color: "#fff" }}
          >
            Conversar com a IA
          ...
          >
            <span style={{ color: "var(--ai)" }}>›</span> 89.412 stacks geradas
            <br />
            <span style={{ color: "var(--ai)" }}>›</span> média de 7 ferramentas/stack
            <br />
