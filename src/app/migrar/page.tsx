...
export default function MigratePage() {
  ...
  return (
    <div className="sx-screen" style={{ overflow: 'hidden' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                {[
                  ...
                  <div key={i} className="sx-card" style={{
                    ...
                    <div>
                      <div style={{ fontSize: 12.5, fontWeight: 500 }}>{fromLabel as string}</div>
                      <div className="sx-mono" style={{ fontSize: 10.5, color: 'var(--text-muted)' }}>{fromKey as string}</div>
                    </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 10px', background: 'var(--surface-2)', borderRadius: 7, border: '1px solid var(--border)' }}>
                      <div>
                        <div style={{ fontSize: 12.5, fontWeight: 500 }}>{toLabel as string}</div>
                        <div className="sx-mono" style={{ fontSize: 10.5, color: 'var(--text-muted)' }}>{toKey as string}</div>
                      </div>
