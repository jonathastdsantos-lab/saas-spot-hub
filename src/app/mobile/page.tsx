...
import { SAAS, CATEGORIES } from '@/lib/data/mock';
...
export default function MobilePreviewPage() {
  return (
    <div className="sx-screen" style={{ overflow: 'auto', background: 'var(--bg-2)' }}>
      <TopNav active="mobile" />
      <div style={{ padding: '40px 80px', display: 'flex', justifyContent: 'center', gap: 80 }}>
        <div>
          <h2 style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-dim)', marginBottom: 24, textAlign: 'center' }}>Home View</h2>
          <Screen_Mobile_Home />
        </div>
        <div>
          <h2 style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-dim)', marginBottom: 24, textAlign: 'center' }}>Consultor IA Chat</h2>
          <Screen_Mobile_Chat />
        </div>
      </div>
    </div>
